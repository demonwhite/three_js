...
SoundObject.prototype.fastForward = function(value) {
    this.sourceBuffer.playbackRate.value += value;
}
SoundObject.prototype.fastBackward = function(value) {
    this.sourceBuffer.playbackRate.value -= value;
}
SoundObject.prototype.resetPlaybackRate = function() {
